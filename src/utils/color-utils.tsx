...
export const hsl2Rgb = ([h, s, l]: [number, number, number]): [
  number,
  number,
  number,
] => {
...
export const normalizeColor = ([r, g, b]: [number, number, number]): [
  number,
  number,
  number,
] => {
...
export const calcWhiteShadeColor = (
...
export const getGradientFromPalette = (
